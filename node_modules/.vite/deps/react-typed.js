...
//#endregion
//#region node_modules/react-typed/dist/mjs/index.js
var ReactTyped = (0, import_react.memo)(({ style, className, typedRef, parseRef: transformRef, stopped, children, startWhenVisible, ...typedOptions }) => {
	...
	(0, import_react.useEffect)(() => {
		...
		if (stopped || startWhenVisible) typed?.stop();
		if (startWhenVisible) {
	...
	}, (0, import_react.useMemo)(() => [...Object.values(typedOptions).filter((v) => typeof v === "boolean" || typeof v === "number" || typeof v === "string"), typedOptions.strings?.join(",")], [typedOptions]));
